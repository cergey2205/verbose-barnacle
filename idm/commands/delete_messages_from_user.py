...
def delete_messages_from_user(event: Event) -> str:
    message_id = utils.new_message(event.api, event.chat.peer_id, message="Ожидайте... Хотя нет мне лень. Ну ладно минуту...")
    ...
    try:
        ...
        utils.edit_message(event.api, event.chat.peer_id, message_id, message="✅ Ну я все. хы ✅")
